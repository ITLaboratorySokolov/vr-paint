...
namespace ZCU.TechnologyLab.Common.Unity.Models.WorldObjects.Properties.Managers
{
    /// <summary>
    ...
    /// or verticies and triangles as arrays are set to MeshPropertiesManager via <see cref="MeshPropertiesManager.SetMesh"/>,
