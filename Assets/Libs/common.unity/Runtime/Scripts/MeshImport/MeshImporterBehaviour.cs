...
namespace ZCU.TechnologyLab.Common.Unity.MeshImport
{
    ...
    public class MeshImporterBehaviour : MonoBehaviour
    {
        ...
        /// <summary>
        /// Imports a mesh from a file or a stream with Assimp.
        /// </summary>
        private readonly MeshImporter meshImporter = new();
        ...
        public void Import()
        {
            ...
            this.meshImporter.Import(this.path);
        }
        ...
        {
            this.meshImporter.Import(stream);
        }
    }
}
