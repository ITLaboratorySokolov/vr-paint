...
namespace ZCU.TechnologyLab.Common.Unity.MeshImport.Conversion
{
    ...
    internal class MeshConverter
    {
        ...
        public MeshMaterialBinding ConvertToUnity(Assimp.Mesh mesh, List<UnityEngine.Material> unityMaterials)
        {
        ...
        public UnityEngine.Vector3[] ConvertVerticesToUnity(List<Assimp.Vector3D> vertices)
        {
        ...
        public List<int> ConvertFacesToUnity(List<Assimp.Face> faces)
        {
        ...
        public UnityEngine.MeshTopology ConvertTopologyToUnity(Assimp.PrimitiveType primitiveType)
        {
        ...
        public UnityEngine.Vector3[] ConvertNormalsToUnity(List<Assimp.Vector3D> normals)
        {
        ...
        public UnityEngine.Vector4[] ConvertTangentsToUnity(List<Assimp.Vector3D> tangents)
        {
        ...
        public UnityEngine.Vector2[] ConvertUvsToUnity(List<Assimp.Vector3D> textureCoordinateChannel)
        {
        ...
        public UnityEngine.Color[] ConvertColorsToUnity(List<Assimp.Color4D> colors)
        {
